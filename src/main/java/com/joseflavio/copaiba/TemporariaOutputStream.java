...
/**
 * {@link OutputStream} que mantém dados em memória.
 * @author José Flávio de Souza Dias Júnior
 */
class TemporariaOutputStream extends ByteArrayOutputStream {

	private int tamanho;

	/**
	 * @param tamanho Tamanho da memória interna no instante inicial e após {@link #reset()}.
	 */
	public TemporariaOutputStream( int tamanho ) {
		super( tamanho );
