...
/**
 * {@link URL} de Javadoc de um conjunto de classes.
...
public class Javadoc {
	...
	/**
	 * @param prefixo Prefixo das classes disponíveis, podendo ser vazio. Ex.: "java.lang."
	 * @param url {@link URL} raiz do Javadoc. Ex.: "http://docs.oracle.com/javase/8/docs/api/"
	 */
	public Javadoc( URL url, String prefixo ) {
		if( url == null || prefixo == null ) throw new IllegalArgumentException();
		this.url = url;
		this.prefixo = prefixo;
	}
	
	/**
	 * @see #Javadoc(URL, String)
	 */
	public Javadoc( String url, String prefixo ) throws MalformedURLException {
		this( new URL( url ), prefixo );
	}
