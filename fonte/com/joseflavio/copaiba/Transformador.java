...
/**
 * Transformador de rotina antes de sua {@link CopaibaConexao#executar(String, String, java.io.Writer) execução}.
...
public interface Transformador {
	...
	/**
	 * Prepara uma rotina de {@link Usuario}, transformando-a, para a sua efetiva {@link CopaibaConexao#executar(String, String, java.io.Writer) execução}.
	 * @return rotina transformada.
	 * @see CopaibaConexao#executar(String, String, java.io.Writer)
	 */
	String transformar( Usuario usuario, String linguagem, String rotina ) throws CopaibaException;
