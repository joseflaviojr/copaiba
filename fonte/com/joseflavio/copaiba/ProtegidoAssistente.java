...
/**
 * {@link Assistente} protegido de alterações.
...
class ProtegidoAssistente implements Assistente {
	...
	ProtegidoAssistente( Assistente assistente ) {
		this.assistente = assistente;
	}

	@Override
	public String[] getClasses() {
		return assistente.getClasses();
	}
	
	@Override
	public boolean contemClasse( String classe ) {
		return assistente.contemClasse( classe );
	}

	@Override
	public String[] getMembros( String classe ) {
		return assistente.getMembros( classe );
	}

	@Override
	public URL getDocumentacao( String componente ) {
		return assistente.getDocumentacao( componente );
	}
