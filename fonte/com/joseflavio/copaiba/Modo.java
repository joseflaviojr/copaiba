...
/**
 * Modos de transferência de dados do protocolo de comunicação da {@link Copaiba}.
 * @author José Flávio de Souza Dias Júnior
 */
public enum Modo {
	
	/**
	 * Transferência de dados conforme o padrão de {@link Serializable serialização} da Java.
