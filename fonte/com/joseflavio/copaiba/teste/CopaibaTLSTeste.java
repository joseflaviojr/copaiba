...
/**
 * {@link CopaibaBaseTeste} em {@link Modo#JAVA} e com TLS/SSL ativado.
 * @author José Flávio de Souza Dias Júnior
 */
public class CopaibaTLSTeste extends CopaibaBaseTeste {
	
	@Override
	protected Consumidor novoConsumidor() throws IOException {
		return new SocketConsumidor( "localhost", TesteServidores.PORTA_SEGURA, true, false );
	}
	
	@Override
	protected CopaibaConexao novaCopaibaConexao( String usuario, String senha ) throws CopaibaException {
		return new CopaibaConexao( "localhost", TesteServidores.PORTA_SEGURA, true, false, Modo.JAVA, usuario, senha );
	}
