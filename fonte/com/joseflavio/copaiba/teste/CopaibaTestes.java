...
/**
 * Todos os testes previstos para a {@link Copaiba}.
 * @author José Flávio de Souza Dias Júnior
 */
@RunWith(Suite.class)
@SuiteClasses({
	CopaibaJavaTeste.class,
	CopaibaJSONTeste.class,
	CopaibaTLSTeste.class,
	CopaibaDiretoTeste.class
})
@FixMethodOrder(MethodSorters.JVM)
public class CopaibaTestes {
}
