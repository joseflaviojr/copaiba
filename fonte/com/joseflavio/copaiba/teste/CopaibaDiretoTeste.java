...
/**
 * {@link CopaibaBaseTeste} em {@link Modo#JAVA} e com {@link DiretoServidor}.
 * @author José Flávio de Souza Dias Júnior
 */
public class CopaibaDiretoTeste extends CopaibaBaseTeste {
	
	@Override
	protected Consumidor novoConsumidor() throws IOException {
		return ((DiretoServidor)servidores.servidorDireto.getServidor()).novoConsumidor();
	}
